...
export const useAnimateScrollView = (imageHeight, disableScale) => {
  ...
  return [scroll, onScroll, disableScale ? 1 : scale, disableScale ? 0 : translateYDown, disableScale ? 0 : translateYUp];
};
